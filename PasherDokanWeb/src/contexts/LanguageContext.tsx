...
const translations = {
  en: {
    ...
    // CTA
    'cta.badge': 'Join the Pilot Program',
    'cta.title': 'Ready to Lead the Revolution in Chattogram?',
    'cta.subtitle': 'Be among the first 100 shopkeepers to lead Bangladesh\'s hyperlocal revolution. Join our exclusive Chattogram pilot program.',
    'cta.formTitle': 'Apply for Pilot Program',
    'cta.formSubtitle': 'Become one of our first 100 partner shops in Chattogram.',
    ...
    'cta.back': 'Back',
    'cta.getStarted': 'Submit Application',
    'cta.basicInfo': 'Basic Info',
    'cta.businessDetails': 'Business Details',
    'cta.successTitle': 'Application Submitted!',
    'cta.successMessage': 'Your pilot program application has been received. We\'ll contact you soon with next steps.',
    'cta.downloadOn': 'Available on',
    'cta.preLaunchTitle': 'Pre-Launch Access',
    'cta.preLaunchMessage': 'Join our pilot program in Chattogram and be among the first to transform your business.',
    ...
    'cta.earlyAccess': 'Get Early Access',
    'cta.pilotDescription': 'Join our Chattogram pilot program and get exclusive early access to PasherDokan.',
  ...
  bn: {
    ...
    // CTA - Bengali
    'cta.badge': 'পাইলট প্রোগ্রামে যোগ দিন',
    'cta.title': 'চট্টগ্রামের পাইলট প্রোগ্রামে আগ্রহী?',
    'cta.subtitle': 'প্রথম ১০০ দোকানদারের মধ্যে থাকুন যারা বাংলাদেশের হাইপারলোকাল বিপ্লবে নেতৃত্ব দেবেন।',
    'cta.formTitle': 'পাইলট প্রোগ্রামের জন্য আবেদন করুন',
    'cta.formSubtitle': 'চট্টগ্রামে আমাদের প্রথম ১০০ পার্টনার দোকানের অংশ হন।',
    'cta.yourName': 'আপনার নাম',
    'cta.namePlaceholder': 'জসীম উদ্দিন',
    'cta.emailAddress': 'ইমেইল ঠিকানা',
    'cta.emailPlaceholder': 'আপনার@উদাহরণ.com',
    ...
    'cta.other': 'অন্যান্য',
    'cta.featuresInterested': 'কোন ফিচারে আপনি সবচেয়ে আগ্রহী?',
    'cta.inventoryManagement': 'ইনভেন্টরি ব্যবস্থাপনা',
    'cta.onlineOrders': 'অনলাইন অর্ডার',
    'cta.customerLoyalty': 'গ্রাহক বিশ্বস্ততা',
    'cta.analytics': 'বিশ্লেষণ',
    'cta.continue': 'পরবর্তী',
    'cta.back': 'পূর্ববর্তী',
    'cta.getStarted': 'আবেদন জমা দিন',
    'cta.basicInfo': 'মৌলিক তথ্য',
    'cta.businessDetails': 'ব্যবসার বিবরণ',
    'cta.successTitle': 'আবেদন সফল!',
    'cta.successMessage': 'পাইলট প্রোগ্রামের জন্য আপনার আবেদন গ্রহণ করা হয়েছে। আমরা শীঘ্রই যোগাযোগ করবো।',
    'cta.preLaunchTitle': 'প্রি-লঞ্চ সুবিধা',
    'cta.preLaunchMessage': 'চট্টগ্রামের পাইলট প্রোগ্রামে যোগ দিন এবং প্রথম সারিতে থাকুন।',
    'cta.forShopOwners': 'দোকানদারদের জন্য',
    'cta.forSuppliersUpcoming': 'সরবরাহকারীদের জন্য (আসছে)',
    'cta.attractCustomers': 'স্থানীয় গ্রাহকদের আকর্ষণ করুন',
    'cta.manageInventory': 'সহজে ইনভেন্টরি পরিচালনা',
    'cta.trackSales': 'রিয়েল-টাইম বিক্রয় ট্র্যাকিং',
    'cta.acceptPayments': 'ডিজিটাল পেমেন্ট গ্রহণ',
    'cta.connectRetailers': 'স্থানীয় খুচরা বিক্রেতাদের সাথে সংযোগ',
    'cta.streamlineDistribution': 'বিতরণ সহজীকরণ',
    'cta.reduceInventory': 'অতিরিক্ত ইনভেন্টরি কমান',
    'cta.growNetwork': 'আপনার ব্যবসায়িক নেটওয়ার্ক বৃদ্ধি',
    'cta.featureDescription': 'শক্তিশালী টুলস যা আপনার ব্যবসা পরিচালনা ও বৃদ্ধিতে সহায়তা করবে।',
    'cta.earlyAccess': 'প্রাথমিক অ্যাক্সেস পান',
    'cta.pilotDescription': 'চট্টগ্রামের পাইলট প্রোগ্রামে অংশ নিন এবং এক্সক্লুসিভ সুবিধা পান।',
