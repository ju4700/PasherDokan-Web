...
const translations = {
  ...
  bn: {
    ...
    'cta.preLaunchTitle': 'প্রি-লঞ্চ অ্যাক্সেস',
    'cta.preLaunchMessage': 'চট্টগ্রামের আমাদের পাইলট প্রোগ্রামে যোগ দিন এবং আপনার ব্যবসা রূপান্তরিত করার প্রথম সারিতে থাকুন।',
